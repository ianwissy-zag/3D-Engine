...
create_clock -add -name tck_dmi -period 100.00 [get_pins -hier -filter {NAME =~ *tap_dmi/TCK}]
create_clock -add -name tck_dtmcs -period 100.00 [get_pins -hier -filter {NAME =~ *tap_dtmcs/TCK}]
create_clock -add -name tck_idcode -period 100.00 [get_pins -hier -filter {NAME =~ *tap_idcode/DRCK}]
