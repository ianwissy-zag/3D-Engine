...
// Keyboard                     
wire [31:0] wb_m2s_kb_adr;
wire [31:0] wb_m2s_kb_dat;
wire  [3:0] wb_m2s_kb_sel;
wire        wb_m2s_kb_we; 
wire        wb_m2s_kb_cyc;
wire        wb_m2s_kb_stb;
wire  [2:0] wb_m2s_kb_cti;
wire  [1:0] wb_m2s_kb_bte;
wire [31:0] wb_s2m_kb_dat;
wire        wb_s2m_kb_ack;
wire        wb_s2m_kb_err;
wire        wb_s2m_kb_rty;
...
//VGA
    ...
    //Keyoard
    .wb_kb_adr_o (wb_m2s_kb_adr),
    .wb_kb_dat_o (wb_m2s_kb_dat),
    .wb_kb_sel_o (wb_m2s_kb_sel),
    .wb_kb_we_o  (wb_m2s_kb_we),
    .wb_kb_cyc_o (wb_m2s_kb_cyc),
    .wb_kb_stb_o (wb_m2s_kb_stb),
    .wb_kb_cti_o (wb_m2s_kb_cti),
    .wb_kb_bte_o (wb_m2s_kb_bte),
    .wb_kb_dat_i (wb_s2m_kb_dat),
    .wb_kb_ack_i (wb_s2m_kb_ack),
    .wb_kb_err_i (wb_s2m_kb_err),
    .wb_kb_rty_i (wb_s2m_kb_rty));