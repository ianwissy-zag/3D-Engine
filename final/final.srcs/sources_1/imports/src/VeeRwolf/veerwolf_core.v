...
`endif
  ...
  `endif
   ...
   // Keyboard 
   wb_ps2_keyboard keyboard (
      .wb_clk_i  (clk),
      .wb_rst_i  (wb_rst),
      .wb_adr_i  (wb_m2s_kb_adr[5:2]),
      .wb_dat_i  (wb_m2s_kb_dat),
      .wb_we_i   (wb_m2s_kb_we),
      .wb_cyc_i  (wb_m2s_kb_cyc),
      .wb_stb_i  (wb_m2s_kb_stb),
      .wb_dat_o  (wb_s2m_kb_dat),
      .wb_ack_o  (wb_s2m_kb_ack),
      // Output Ports
      .ps2_clk   (ps2_clk),
      .ps2_data  (ps2_data)
   );
